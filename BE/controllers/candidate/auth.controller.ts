...
export const loginPost = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const result = await candidateAuthService.loginCandidateService(
      String(body.email || ""),
...
export const otpPasswordPost = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const result = await candidateAuthService.verifyOtpCandidateService(
      String(body.email || ""),
      String(body.otp || "")
    );
...
export const resetPasswordPost = async (req: RequestAccount, res: Response): Promise<void> => {
  try {
    ...
    const result = await candidateAuthService.resetPasswordCandidateService(
