...
export const profilePatch = async (req: RequestAccount, res: Response): Promise<void> => {
  try {
    ...
    const result = await companyProfileService.updateCompanyProfileService(
      company,
      body,
...
export const requestEmailChange = async (req: RequestAccount, res: Response): Promise<void> => {
  try {
    ...
    const result = await companyProfileService.requestCompanyEmailChangeService(
      company,
...
export const verifyEmailChange = async (req: RequestAccount, res: Response): Promise<void> => {
  try {
    ...
    const result = await companyProfileService.verifyCompanyEmailChangeService(
      company._id,
      String(body.otp || "")
    );
