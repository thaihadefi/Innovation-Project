...
export const interviewTipsSections: InterviewTipsSection[] = [
  {
    ...
    children: [
      { title: "Code templates", href: "/interview-tips/dsa/code-templates" },
      { title: "Stages of an interview", href: "/interview-tips/dsa/stages-of-an-interview" },
      { title: "Cheatsheets", href: "/interview-tips/dsa/cheatsheets" },
    ],
  },
];
