    ...
    <section className="article-content rounded-[16px] border border-[#E5E7EB] bg-white p-[16px] sm:p-[24px] shadow-sm">
      ...
      <div className="mt-[16px] space-y-[18px]">
        ...
        <div className="space-y-[18px]">
          <div>
            <h3 className="text-[18px] font-[700] text-[#111827]">1. LeetCode</h3>
            ...
            <p className="mt-[8px] text-[14px] text-[#374151]">
              If you are ever stuck on a problem, don&apos;t just stare at it for an hour. Read
              the official solution if available, or go to the discuss section and look at the
              solution there. Make sure you 100% understand the algorithm, then move on to the next
              problem, and come back to the problem you were stuck on in a few days or a week.
            </p>
            <p className="mt-[8px] text-[14px] text-[#374151]">
              ...
              , and more. The contests are a great way to practice for interviews. Every contest
              has 4 new questions, usually an easy, two mediums, and a hard, with only 90 minutes
              to finish, simulating a high-pressure timed environment. You can also do virtual
              contests for any of the past contests.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-[18px] font-[700] text-[#111827]">2. CSES Problem Set</h3>
            <p className="mt-[8px] text-[14px] text-[#374151]">
              <Link
                href="https://cses.fi/"
                target="_blank"
          ...
          <div>
            <h3 className="text-[18px] font-[700] text-[#111827]">3. USACO Guide</h3>
            <p className="mt-[8px] text-[14px] text-[#374151]">
              <Link
            ...
            <p className="mt-[10px] text-[14px] text-[#374151]">
              ...
              instead of random problem picking, and it helps close theoretical gaps before
              interview practice.
            </p>
          </div>
        </div>
