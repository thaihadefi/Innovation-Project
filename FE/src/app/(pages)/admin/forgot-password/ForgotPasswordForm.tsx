  ...
  return (
    <form className="grid grid-cols-1 gap-y-[15px]" onSubmit={handleSubmit(onSubmit, (errs) => {
      ...
      <div>
        ...
        <input type="email" id="email" placeholder="Enter your admin email" autoComplete="email"
      ...
      <div className="text-center">
        <Link href="/admin/login" className="font-[500] text-[14px] text-[#0088FF] hover:underline">
          Back to Login
        </Link>
      </div>
    </form>
